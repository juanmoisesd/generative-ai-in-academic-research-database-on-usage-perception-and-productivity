# Contributing to Generative AI in Academic Research: Database on Usage, Perception and Productivity

Thank you for your interest in contributing to **Generative AI in Academic Research: Database on Usage, Perception and Productivity**!
...
Open an [Issue](https://github.com/juanmoisesd/generative-ai-in-academic-research-database-on-usage-perception-and-productivity/issues) describing:
...
```bibtex
@misc{delaserna_generative_ai_in_academic_research_database_on_usage_perception_and_productivity,
...
*Questions? Contact via [GitHub Issues](https://github.com/juanmoisesd/generative-ai-in-academic-research-database-on-usage-perception-and-productivity/issues).*
